<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="sucessstoriesuser_admin.aspx.cs" Inherits="sucessstoriesuser_admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="style6">
        <tr>
            <td width="20%">
                &nbsp;</td>
            <td align="center" style="font-size: large; color: #FF0000; font-weight: bold">
                Success stories</td>
            <td width="20%">
                &nbsp;</td>
        </tr>
        <tr>
            ...
            <td align="center">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                    DataKeyNames="SSID" DataSourceID="SqlDataSource1" AllowPaging="True" 
