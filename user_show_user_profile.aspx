<%@ Page Title="" Language="C#" MasterPageFile="~/user_panel_MasterPage.master" AutoEventWireup="true" CodeFile="user_show_user_profile.aspx.cs" Inherits="user_show_user_profile" %>
        ...
        <tr>
            <td align="left" valign="top" width="45%">
                <asp:DetailsView ID="detailviewbasic" runat="server" AutoGenerateRows="False" 
                    DataKeyNames="Registration_no" DataSourceID="SqlDataSource1" Height="296px" 
                    Width="340px">
                    <Fields>
                        ...
                        <asp:BoundField DataField="Registration_no" HeaderText="Registration no" 
                            ReadOnly="True" SortExpression="Registration_no" Visible="false" />
            ...
            <td align="left" valign="top">
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ...
                    SelectCommand="SELECT * FROM [user_personal] WHERE ([Registration_no] = @Registration_no)">
                    <SelectParameters>
                        <asp:SessionParameter Name="Registration_no" SessionField="rnosearch" 
                            Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </td>
