<%@ Page Title="" Language="C#" MasterPageFile="~/user_panel_MasterPage.master" AutoEventWireup="true" CodeFile="changephoto_user.aspx.cs" Inherits="changephoto_user" %>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="btnchangephoto" runat="server" onclick="btnchangephoto_Click" 
                    ...
                    Font-Names="Times New Roman" Font-Size="Medium" ForeColor="White" Height="31px" 
                    Width="80px" />
            &nbsp;&nbsp;
