<%@ Page Title="" Language="C#" MasterPageFile="~/user_panel_MasterPage.master" AutoEventWireup="true" CodeFile="editbasic_user.aspx.cs" Inherits="editbasic_user" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="style3" style="width: 906px">
        <tr>
            <td class="style19">
                &nbsp;</td>
            <td class="style16">
        ...
        <tr>
            ...
            <td class="style16">
                &nbsp;</td>
            <td>
                <asp:Button ID="btnupdatebasic" runat="server" onclick="btnupdatebasic_Click" 
