...
public partial class sucessinsert : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("sucessstoriesuser.aspx");
        con.Close();
    }
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand sql1 = new SqlCommand("delete from user_success", con);
